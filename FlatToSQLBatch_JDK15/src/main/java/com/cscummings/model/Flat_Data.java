...
@IdClass(Flat_Data_PK.class)
public class Flat_Data implements Serializable {
	...
	public String toString() {
		return "Flat_Data [RECORD_TYPE=" + RECORD_TYPE + ", SSN=" + SSN + ", EMPLOYER_NAME=" + EMPLOYER_NAME
