...
public class Flat_Data_PK implements Serializable {
	...
	public Flat_Data_PK(String RECORD_TYPE, String SSN, String EMPLOYER_NAME) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Flat_Data_PK other = (Flat_Data_PK) obj;
	...
	public String toString() {
		return "Flat_Data_PK [RECORD_TYPE=" + RECORD_TYPE + ", SSN=" + SSN + ", EMPLOYER_NAME=" + EMPLOYER_NAME + "]";
	}
